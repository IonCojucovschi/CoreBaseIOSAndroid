...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Int.Droid.Transformations.FadeTransformer, Int.Droid", FadeTransformer.class, __md_methods);
	}
	...
	public FadeTransformer ()
	{
		...
		if (getClass () == FadeTransformer.class)
			mono.android.TypeManager.Activate ("Int.Droid.Transformations.FadeTransformer, Int.Droid", "", this, new java.lang.Object[] {  });
	}
