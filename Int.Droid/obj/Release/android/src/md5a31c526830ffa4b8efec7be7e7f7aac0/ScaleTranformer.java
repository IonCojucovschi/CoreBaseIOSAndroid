...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Int.Droid.Transformations.ScaleTranformer, Int.Droid", ScaleTranformer.class, __md_methods);
	}


	public ScaleTranformer ()
	{
		super ();
		if (getClass () == ScaleTranformer.class)
			mono.android.TypeManager.Activate ("Int.Droid.Transformations.ScaleTranformer, Int.Droid", "", this, new java.lang.Object[] {  });
	}
