...
public class CrossTextWrapper_TextChangeListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Int.Droid.Wrappers.Widget.FactoryConcreteProducts.CrossTextWrapper+TextChangeListener, Int.Droid", CrossTextWrapper_TextChangeListener.class, __md_methods);
	}


	public CrossTextWrapper_TextChangeListener ()
	{
		super ();
		if (getClass () == CrossTextWrapper_TextChangeListener.class)
			mono.android.TypeManager.Activate ("Int.Droid.Wrappers.Widget.FactoryConcreteProducts.CrossTextWrapper+TextChangeListener, Int.Droid", "", this, new java.lang.Object[] {  });
	}
